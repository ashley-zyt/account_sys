class CreateNotebooklmKeywords < ActiveRecord::Migration[6.1]
  def change
    create_table :notebooklm_keywords do |t|
    ...
    add_index :notebooklm_keywords, :theme
    add_index :notebooklm_keywords, :status
    add_index :notebooklm_keywords, [:theme, :status]
  end
end